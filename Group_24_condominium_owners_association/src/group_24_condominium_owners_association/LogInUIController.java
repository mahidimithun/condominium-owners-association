...
//    private static final String USERS_FILE = "C:\\Users\\HP\\Desktop\\users.txt";
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        cb_userType.getItems().addAll("UnitOwner", "MR", "MedicalResponseCoordinator", "FinancialManager","RuelsAndPolicyManager","SecurityControlOfficer","EventManagerDashboard","CommercialOwnerDashboard");
    }

    @FXML
    private void userRegistraionOnClick(ActionEvent event) throws IOException {
    ...
    private void logInOnClick(ActionEvent event) throws IOException {
        ...
        if (valid) {
            ...
            if (userType.equals("UnitOwner")) {
             ...
             else if (userType.equals("CommercialOwnerDashboard")) {
